# 133 - Profile Transition System

**Status:** Superseded by issue 136 (canonical-profile-definitions).
The profile semantics described here are stale. Kept for traceability.
...
- `issues/133-profile-transition-system.md` - This file (was 405)
- `issues/134-alpha-baseline-setup.md` - Alpha baseline documentation (was 406)

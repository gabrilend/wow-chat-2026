# 903 - Contextual Creature Spawns

**Migrated from:** issues/127-contextual-creature-spawns.md
...
## Dependencies
- Issue 902: dungeon-room-spawn-zones (waypoint grouping concept)
...
## Related Issues
- 902-dungeon-room-spawn-zones (waypoint grouping)
- 904-embedding-based-creature-selection (semantic selection within type)

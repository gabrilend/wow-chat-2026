...
- Patch B002 (`docs/patches/playerbots-ale-login-hook.md`) — Added `sALE->OnLogin(bot)` to fire Lua events for bots
- Issue 307: ALE gameobject wildcard (resolved - no more gameobject errors)
- Issue 125: Algorism priority scheduler (research) - WorldTick architecture solves this elegantly
